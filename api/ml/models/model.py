...
def main(stock_name):
    ...
    # stocks = ['WMT', 'AMZN' , 'AAPL' , 'CVS.F' , 'GOOGL', 'GE', 'IBM', 'MSFT', 'META', 'DELL' , 'NFLX', 'JPM' ]
    ...
    # # return this in JSON. Later convert to CSV on frontend
    predictions = _model_prediction_blind_run(df_feature_engineering,best_model,14)

    # #return
    df = _plot(df_model, stock_name, best_model)
    return {
